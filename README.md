...
Pada awal program akan menampilkan menu awal seperti pada gambar diatas, kita diminta menginput angka yang kita pilih.

![Screenshot 2024-10-15 024735](https://github.com/user-attachments/assets/b27e9725-b815-473d-9ef8-b8b73ab821ab)

Kemudian kita akan diminta untuk menginput username dan password sebagai customer

![Screenshot 2024-10-15 024745](https://github.com/user-attachments/assets/dd15632a-9e06-469d-92f4-03b4db457d70)

Login berhasil sebagai customer, maka akan muncul semua menu untuk customer dan customer akan diminta untuk menginput pilihan. 
...
Apabila customer memilih 1, maka program akan menampilkan daftar baju yang tersedia

![Screenshot 2024-10-15 030431](https://github.com/user-attachments/assets/555dccab-fbc5-4d7e-b7f2-b69ee9c30983)

Apabila customer memilih 2, maka akan melakukan transaksi dalam penyewaan baju adat. Customer akan diminta untuk memasukkan kode baju yang ingin disewa, nama penyewa, dan lama sewa. setelah itu, baju berhasil untuk disewa dengan total harga sewa yang tertera pada terminal

![Screenshot 2024-10-15 035141](https://github.com/user-attachments/assets/aa85cfb0-fcb4-4f58-802b-e3949ea49af4)

Apabila memilih 3, maka baju yang disewa oleh customer akan dikembalikan dan status baju untuk kode tersebut akan kembali tersedia

![Screenshot 2024-10-15 030723](https://github.com/user-attachments/assets/135a7c28-ae5d-4df6-acea-969364005de2)

Jika memilih 4, maka akan kembali ke menu utama untuk memilih role atau keluar dari program
...
Kemudian kita akan diminta untuk menginput username dan password sebagai admin


![Screenshot 2024-10-15 030951](https://github.com/user-attachments/assets/343e83cf-5437-4a7b-be9b-d7b3ebf593eb)
    
Login berhasil sebagai customer, maka akan muncul semua menu untuk admin dan admin akan diminta untuk menginput pilihan. 
...
![Screenshot 2024-10-15 032943](https://github.com/user-attachments/assets/f2513a14-38ee-40c6-b5ce-7645a090cd69)

Apabila admin memilih 1, maka program akan menampilkan daftar baju yang tersedia

![Screenshot 2024-10-15 033050](https://github.com/user-attachments/assets/ff23b86c-59b4-43dc-8b58-aa87393c2379)

Apabila admin memilih 2, maka akan menambahkan data baju baru yang akan ditampilkan pada table dengan cara memasukkan nama baju, masa sewa, dan harga sewa. Maka, data untuk baju baru berhasil ditambahkan pada table 


![Screenshot 2024-10-15 034351](https://github.com/user-attachments/assets/d26eb141-a1c0-4dcc-a44d-ed52c1932671)

Apabila memilih 3, maka akan mengupdate data baju yang ada di dalam table. Disini akan mengubah dari kode baju, nama baru, masa sewa, dan harga baju. Lalu, data baju akan berhasil diupdate

![Screenshot 2024-10-15 034700](https://github.com/user-attachments/assets/b3270ee6-f507-487f-abac-beaafb009d62)

Apabila memilih 4, maka akan menghapus salah satu data baju yang ada di dalam table dengan cara menmasukkan kode baju yang ingin dihapus.

![Screenshot 2024-10-15 034726](https://github.com/user-attachments/assets/81f38730-2f14-4bd2-b845-9df859567c7e)


![Screenshot 2024-10-15 034726](https://github.com/user-attachments/assets/19f24447-e6ed-4046-97f5-65275d94bbaa)

Apabila memilih 5, maka akan menampilkan riwayat customer yang menyewa baju adat. Disini akan ditampilkan nama penyewa, kode baju, nama baju, lama sewa, dan total harga sewa

Apabila memilih 6, maka akan kembali ke menu utama untuk memilih role atau keluar dari program

![Screenshot 2024-10-15 035101](https://github.com/user-attachments/assets/476a70d9-d4e4-4915-afa4-c88198a758ec)
